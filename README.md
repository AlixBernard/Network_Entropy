...
**IMPORTANT**: This implementation only works for the case taken into account in [\[1\]][1]. In order to  use it for other types of networks some modifications are in order, such as modifying the entries of the matrix `Xi` (cf. [\[1\]][1] & [\[2\]][2] for more details).  
